...
- End user checkpoint: `docs/DESIGN.md` is checked against `docs/USE_CASES.md` by the enduser agent before it feeds architecture (`DESIGN-METHODOLOGY.md` 4.1). You cannot dispatch another agent, so say in your final message that the check is needed
